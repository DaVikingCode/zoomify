    ...
    class extends HTMLElement {
        ...
        touchEnd(event) {
            if (this.scaling) {
                ...
                this.endDrag(event);
                if (!this.hasMoved) this.photoClicked(event);
            }
            else event.preventDefault();
        }
        ...
        getZoomedPoint(event) {
            ...
            console.log({
                'touchX': this.touchCenterX,
                'touchY': this.touchCenterY
            });
            ...
            if (event.touches && event.touches.length > 0)
            {
                ...
                let x = event.touches[0].pageX - this.rect.x - this.x;
                let y = event.touches[0].pageY - this.rect.y - this.y;
            }
            else
            {
                // Get current coordinates
